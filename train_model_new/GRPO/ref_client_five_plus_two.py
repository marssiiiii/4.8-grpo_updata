...
base_model_path="/home/jiuxing_li/five_plus_two_optimization/train_model_new/GRPO/save_model/grpo_fpt_api/grpo_fpt_api_4/step_4000" #var
...
def batch_worker(): 
    ...
    def get_per_token_logps(input_ids): #返回裸模型输出的token概率分布
    ...
    while True: 
        try:
            ...
            with torch.inference_mode():
                per_token_logps = get_per_token_logps(inputs.to(ref_model.device)) #计算裸模型per_token_logps
