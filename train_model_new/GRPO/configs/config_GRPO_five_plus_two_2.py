...
@dataclass
class Config:
    #model_path: str = "/mnt/efs/jiuxing_li/five_plus_two_optimization/train_model_new/GRPO/base_model/qwen1.5b" #var
    model_path:str = "/mnt/efs/jiuxing_li/five_plus_two_optimization/train_model_new/GRPO/base_model/ernie_base_model_7"
    gen_device: int = 2 #var
