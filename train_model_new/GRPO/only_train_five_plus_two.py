# -*- coding: utf-8 -*-
# deepspeed --include localhost:0 only_train_five_plus_two.py
...
def main():
    ...
    output_file="/home/jiuxing_li/five_plus_two_optimization/train_model_new/GRPO/save_model/grpo_fpt_api/grpo_fpt_api_4_2" #var
